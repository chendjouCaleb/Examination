...
import {SemesterLevelSpeciality} from "@examination/models/entities";
...
@Component({
  template: `
    ...
    <div>
        <CourseSessionList [params]="{semesterLevelSpecialityId: semesterLevelSpeciality.id}" 
                            [hiddenColumns]="['semester', 'year', 'department', 'levelSpeciality']">
            
        </CourseSessionList>
    </div>
  `
})
export class SemesterLevelSpecialityCourseSessionsPage {
