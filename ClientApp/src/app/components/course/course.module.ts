...
import {MsfButtonModule, MsfCheckboxModule, MsfMenuModule, MsfModalModule, MsfTableModule} from 'fabric-docs';
...
@NgModule({
  imports: [CommonModule, FormsModule, ReactiveFormsModule, AppFormModule,
    MsfButtonModule, MsfSelectModule, MsfModalModule, MsfMenuModule, MsfTableModule, ControlModule, LayoutModule, MsfCheckboxModule],
